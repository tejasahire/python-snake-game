...
sb.ht()
sb.goto(-250,250)
sb.write("Score:0 | Highest Score:0") #to print a score borad in front
...
while True:
    ...
    if head.distance(food)<20:
        ...
        delay=delay-0.0090 #increase the speed

        if sc>hs:
            hs=sc  #update heighest score

        sb.clear()
        sb.write("Score:{} | Heighest Score:{}".format(sc,hs))
